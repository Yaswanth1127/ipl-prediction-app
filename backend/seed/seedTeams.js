...
const teams = [
  {
    ...
    players: {
      ...
      bowlers: [
        "Jofra Archer","Ravi Bishnoi","Sandeep Sharma","Tushar Deshpande",
        "Kwena Maphaka","Nandre Burger","Sushant Mishra","Yash Raj Punja",
        "Vignesh Puthur","Yudhvir Singh Charak"
      ]
    }
  },

  {
    ...
    players: {
      ...
      allRounders: [
        ...
        "Prashant Veer","Matthew Short","Aman Khan","Zak Foulkes"
      ],
      bowlers: [
        "Khaleel Ahmed","Noor Ahmad","Mukesh Choudhary","Spencer Johnson",
        "Shreyas Gopal","Gurjapneet Singh","Akeal Hosein","Matt Henry","Rahul Chahar"
      ]
    }
  },

  {
    ...
    players: {
      ...
      bowlers: [
        ...
        "Lungi Ngidi","Kyle Jamieson","Kuldeep Yadav"
      ]
    }
  },

  {
    ...
    players: {
      ...
      bowlers: [
        ...
        "Gurnoor Singh Brar","Rashid Khan","Manav Suthar","Sai Kishore",
        "Jayant Yadav","Ashok Sharma","Arshad Khan"
      ]
    }
  },

  {
    ...
    players: {
      ...
      bowlers: [
        "Varun Chakravarthy","Vaibhav Arora","Umran Malik","Matheesha Pathirana",
        "Kartik Tyagi","Prashant Solanki","Saurabh Dubey","Harshit Rana"
      ]
    }
  },

  {
    ...
    players: {
      ...
      bowlers: [
        "Mohammad Shami","Avesh Khan","Mayank Yadav","Mohsin Khan",
        "M Siddharth","Digvesh Singh","Akash Singh","Prince Yadav",
        "Arjun Tendulkar","Anrich Nortje","Naman Tiwari"
      ]
    }
  },

  {
    ...
    players: {
      ...
      bowlers: [
        ...
        "Mayank Markande","Allah Ghafanzar","Ashwani Kumar",
...

  {
    ...
    players: {
      ...
      allRounders: [
        ...
        "Jacob Bethell","Venkatesh Iyer","Satvik Deswal",
        "Mangesh Yadav","Vicky Ostwal","Vihaan Malhotra","Kanishk Chouhan"
      ],
      bowlers: [
        "Josh Hazlewood","Yash Dayal","Bhuvneshwar Kumar","Nuwan Thushara",
        "Rasikh Salam","Abhinandan Singh","Suyash Sharma","Jacob Duffy"
      ]
    }
  },
...
const seed = async () => {
  ...
  console.log("🔥 ALL IPL TEAMS WITH FULL SQUADS INSERTED");
  process.exit();
};
